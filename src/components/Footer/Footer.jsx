...
export default function Footer() {
    return (
        <footer className="bg-light text-dark py-5" style={{ lineHeight: '2' }}>
            <div className="container">
                ...
                <div className="row text-center mt-5">
                    <div className="col">
                        <p className="text-muted">© 2025 <a href="#" className="text-secondary fw-bold">MentorShip</a>. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </footer>
